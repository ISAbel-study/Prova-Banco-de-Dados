...
def main():
    ...
    colecao.insert_one(nov_parti) # LACUNA 4: Método de inserção
    ...
    filtro_delete = {"nome": "Participante vinteUm"}
    ...
    # Consulta avançado usando a coleção 'eventos'
    colecao_event = dbname['eventos']

    pipeline = [
        { # Agrupar com $group pela variável "local"
            "$group" : { 
                "_id" : "$local",
